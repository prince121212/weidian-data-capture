...
class ZhizunQinghuaCorrectCollector:
    def __init__(self):
        """初始化商品搜集器"""
        self.products = []
...
def main():
    """主函数"""
    print("=" * 60)
    print("🎯 至尊青花商品搜集工具 (使用正确API)")
    print("=" * 60)
    
    collector = ZhizunQinghuaCorrectCollector()
    
    # 至尊青花分类信息
    shop_id = "1286456178"
    cate_id = "139661840"  # 至尊青花的分类ID
    category_name = "至尊青花"
    ...
    if products:
        # 保存到xlsx文件
        filename = "data/至尊青花_商品列表_正确API.xlsx"
